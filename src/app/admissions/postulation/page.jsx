      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
            ...
            <div className="pt-6 text-center">
              <button
                type="submit"
                className="px-12 py-4 bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white font-bold text-lg rounded-lg transition-colors shadow-lg hover:shadow-xl"
              >
